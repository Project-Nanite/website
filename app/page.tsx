      ...
      <section className="relative">
        <div className="container mx-auto px-6 lg:px-8 py-16 pt-24 max-w-7xl">
          <div className={`text-center mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {/* Status Badge */}
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-100 to-blue-100 text-green-800 rounded-full text-sm font-semibold mb-8 border border-green-200 shadow-lg backdrop-blur-sm">
            ...
            <div className="relative flex flex-col lg:flex-row items-center justify-between gap-16 mb-16">
              ...
              <div className="flex-1 text-center lg:text-left max-w-2xl">
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-8 leading-tight">
                  ...
                  <span className="block text-3xl md:text-4xl lg:text-5xl font-bold text-gray-700 mt-4">
                    of AI Development
                  </span>
                </h1>

                <p className="text-lg md:text-xl lg:text-2xl text-gray-600 mb-12 leading-relaxed">
                  <span className="font-semibold text-yellow-600">Nanite</span> is the revolutionary Linux distribution designed exclusively for
                ...
                <form onSubmit={handleEmailSubmit} className="max-w-md mx-auto lg:mx-0 mb-12">
                  <div className="flex gap-3 p-2 bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-200">
                    <input
                      type="email"
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      placeholder="Enter your email for early access"
                      className="flex-1 px-6 py-4 bg-transparent border-none focus:outline-none text-gray-900 placeholder-gray-500 text-lg"
                      required
                    />
                    <button
                      type="submit"
                  ...
                  {isSubscribed && (
                    <div className="mt-4 p-4 bg-green-100 text-green-800 rounded-xl border border-green-200 animate-fade-in">
              ...
              <div className="flex-1 relative max-w-lg">
                ...
                <div className="absolute -bottom-8 -left-4 bg-white/95 backdrop-blur-sm rounded-2xl p-4 border border-yellow-200 shadow-xl">
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-yellow-400 rounded-full animate-pulse"></div>
                    <span className="text-sm font-semibold text-gray-800">Efficient & Organized</span>
                  </div>
                </div>

                <div className="absolute -top-4 -right-8 bg-white/95 backdrop-blur-sm rounded-2xl p-4 border border-orange-200 shadow-xl">
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-orange-400 rounded-full animate-pulse"></div>
                    <span className="text-sm font-semibold text-gray-800">Collaborative</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                ...
                <div key={index} className="group relative p-8 bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-gray-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105 cursor-pointer">
      ...
      <section className="py-16">
        <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
          <div className={`text-center transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="bg-gradient-to-r from-yellow-50/80 to-orange-50/80 rounded-3xl p-12 border border-yellow-200/50 backdrop-blur-sm relative overflow-hidden">
              {/* Hexagon Pattern Background */}
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <Link 
                    href="/download" 
                    className="bg-white text-gray-900 font-bold px-12 py-4 rounded-2xl border-2 border-yellow-300 hover:border-orange-500 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 transform text-lg"
                  >
                    View Downloads
                  </Link>
                </div>
